...
from tensorflow.keras.layers import Input, GRU, Dense, Dropout, RepeatVector, SimpleRNN

#input_shape (window_size, feature_size)
def make_autoencoder(input_shape, activation = "relu", hidden_layer_size = 16):
    """
